  ...
  return (
    <div>
          ...
          <main className="pt-[5.5rem] lg:pt-24">
            {/* Page Title */}
            <section className="relative py-32 bg-center bg-no-repeat bg-cover after:bg-jacarta-900/60 after:absolute after:inset-0" style={{backgroundImage: 'url("./img/page-title/knowledge_base_banner.jpg")'}}>
              <div className="container relative z-10">
                <h1 className="text-4xl font-medium text-center text-white font-display">Get in touch</h1>
              </div>
            </section>
            {/* Contact */}
                    ...
                    <form id="contact-form" method="post">
                      <div className="flex space-x-7">
                        <div className="w-1/2 mb-6">
                          <label htmlFor="name" className="block mb-1 text-sm font-display text-jacarta-700 dark:text-white">Name<span className="text-red">*</span></label>
                          <input name="name" className="w-full py-3 rounded-lg contact-form-input dark:bg-jacarta-700 border-jacarta-100 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:placeholder:text-jacarta-300 hover:ring-2 dark:text-white" id="name" type="text" required />
                        </div>
                        <div className="w-1/2 mb-6">
                          <label htmlFor="email" className="block mb-1 text-sm font-display text-jacarta-700 dark:text-white">Email<span className="text-red">*</span></label>
                          <input name="email" className="w-full py-3 rounded-lg contact-form-input dark:bg-jacarta-700 border-jacarta-100 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:placeholder:text-jacarta-300 hover:ring-2 dark:text-white" id="email" type="email" required />
                        </div>
                      </div>
                      <div className="mb-4">
                        <label htmlFor="message" className="block mb-1 text-sm font-display text-jacarta-700 dark:text-white">Message<span className="text-red">*</span></label>
                        <textarea id="message" className="w-full py-3 rounded-lg contact-form-input dark:bg-jacarta-700 border-jacarta-100 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:placeholder:text-jacarta-300 hover:ring-2 dark:text-white" required name="message" rows={5} defaultValue={""} />
                      </div>
                      <div className="flex items-center mb-6 space-x-2">
                        <input type="checkbox" id="contact-form-consent-input" name="agree-to-terms" className="self-start w-5 h-5 rounded checked:bg-accent dark:bg-jacarta-600 text-accent border-jacarta-200 focus:ring-accent/20 dark:border-jacarta-500 focus:ring-offset-0" />
                        <label htmlFor="contact-form-consent-input" className="text-sm dark:text-jacarta-200">I agree to the <a href="tos.html" className="text-accent">Terms of Service</a></label>
                      </div>
                      <button type="submit" className="px-8 py-3 font-semibold text-center text-white transition-all rounded-full bg-accent shadow-accent-volume hover:bg-accent-dark" id="contact-form-submit">
                        Submit
                      </button>
                      <div id="contact-form-notice" className="relative hidden p-4 mt-4 border border-transparent rounded-lg" />
                    </form>
                  </div>
                  {/* Info */}
