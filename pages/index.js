...
// const AppBundle  = dynamic(() => import( '../public/js/app.bundle'), {suspense: true});
// const CountdownBundle = dynamic(() => import( '../public/js/countdown.bundle'), {suspense: true});
...
function Home2() {
  return (
    <div>
          ...
          {/* JS Scripts */}
          {/* <Script src='../public/js/app.bundle' strategy="lazyOnload" />
          <Script src='../public/js/countdown.bundle' strategy="lazyOnload" /> */}
