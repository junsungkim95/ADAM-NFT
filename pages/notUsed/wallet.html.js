  ...
  return (
    <div>
          ...
          <main className="pt-[5.5rem] lg:pt-24">
            {/* Wallet */}
            <section className="relative py-24 bg-center bg-no-repeat bg-cover after:bg-jacarta-900/60 after:absolute after:inset-0" style={{backgroundImage: 'url("./img/page-title/wallet_banner.jpg")'}}>
              <div className="container relative z-10">
                <h1 className="text-4xl font-medium text-center text-white font-display">Connect your wallet</h1>
              </div>
            </section>
            <section className="relative pb-20 dark:bg-jacarta-800 pt-28">
              ...
              <div className="container">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 md:gap-[1.875rem]">
                  <a href="#" className="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 rounded-2.5xl mb-8 border bg-white p-8 text-center transition-shadow hover:shadow-lg">
                    <img src="img/wallets/metamask.svg" className="dark:border-jacarta-600 dark:bg-jacarta-700 border-jacarta-100 mx-auto mb-7 -mt-[3.5rem] h-[5.5rem] w-[5.5rem] rounded-full border bg-white" alt="wallet" />
                    <h3 className="mb-3 font-display text-jacarta-700 text-md dark:text-white">Metamask</h3>
                    <p className="dark:text-jacarta-300">
                      Start exploring blockchain applications in seconds. Trusted by over 1 million users worldwide.
                    </p>
                  </a>
                  <a href="#" className="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 rounded-2.5xl mb-8 border bg-white p-8 text-center transition-shadow hover:shadow-lg">
                    <img src="img/wallets/coinbase.svg" className="dark:border-jacarta-600 dark:bg-jacarta-700 border-jacarta-100 mx-auto mb-7 -mt-[3.5rem] h-[5.5rem] w-[5.5rem] rounded-full border bg-white" alt="wallet" />
                    <h3 className="mb-3 font-display text-jacarta-700 text-md dark:text-white">Coinbase</h3>
                    <p className="dark:text-jacarta-300">
                      The easiest and most secure crypto wallet. ... No Coinbase account required.
                    </p>
                  </a>
                  <a href="#" className="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 rounded-2.5xl mb-8 border bg-white p-8 text-center transition-shadow hover:shadow-lg">
                    <img src="img/wallets/bitski.svg" className="dark:border-jacarta-600 dark:bg-jacarta-700 border-jacarta-100 mx-auto mb-7 -mt-[3.5rem] h-[5.5rem] w-[5.5rem] rounded-full border bg-white" alt="wallet" />
                    <h3 className="mb-3 font-display text-jacarta-700 text-md dark:text-white">Bitski</h3>
                    <p className="dark:text-jacarta-300">
                      Bitski connects communities, creators and brands through unique, ownable digital content.
                    </p>
                  </a>
                  <a href="#" className="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 rounded-2.5xl mb-8 border bg-white p-8 text-center transition-shadow hover:shadow-lg">
                    <img src="img/wallets/fortmatic.svg" className="dark:border-jacarta-600 dark:bg-jacarta-700 border-jacarta-100 mx-auto mb-7 -mt-[3.5rem] h-[5.5rem] w-[5.5rem] rounded-full border bg-white" alt="wallet" />
                    <h3 className="mb-3 font-display text-jacarta-700 text-md dark:text-white">Fortmatic</h3>
                    <p className="dark:text-jacarta-300">
                      Let users access your Ethereum app from anywhere. No more browser extensions.
                    </p>
                  </a>
                  <a href="#" className="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 rounded-2.5xl mb-8 border bg-white p-8 text-center transition-shadow hover:shadow-lg">
                    <img src="img/wallets/torus.svg" className="dark:border-jacarta-600 dark:bg-jacarta-700 border-jacarta-100 mx-auto mb-7 -mt-[3.5rem] h-[5.5rem] w-[5.5rem] rounded-full border bg-white" alt="wallet" />
                    <h3 className="mb-3 font-display text-jacarta-700 text-md dark:text-white">Torus</h3>
                    <p className="dark:text-jacarta-300">
                      Open source protocol for connecting decentralised applications to mobile wallets.
                    </p>
                  </a>
                  <a href="#" className="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 rounded-2.5xl mb-8 border bg-white p-8 text-center transition-shadow hover:shadow-lg">
                    <img src="img/wallets/wallet_connect.svg" className="dark:border-jacarta-600 dark:bg-jacarta-700 border-jacarta-100 mx-auto mb-7 -mt-[3.5rem] h-[5.5rem] w-[5.5rem] rounded-full border bg-white" alt="wallet" />
                    <h3 className="mb-3 font-display text-jacarta-700 text-md dark:text-white">Wallet Connect</h3>
                    <p className="dark:text-jacarta-300">
                      Open source protocol for connecting decentralised applications to mobile wallets.
                    </p>
                  </a>
