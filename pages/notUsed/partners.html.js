          ...
          <main className="pt-[5.5rem] lg:pt-24">
            ...
            <section className="relative pt-32 pb-24">
              <picture className="absolute inset-0 pointer-events-none -z-10 dark:hidden">
                <img src="img/gradient.jpg" alt="gradient" className="w-full h-full" />
              </picture>
              <picture className="absolute inset-0 hidden pointer-events-none -z-10 dark:block">
                <img src="img/gradient_dark.jpg" alt="gradient dark" className="w-full h-full" />
              </picture>
              <div className="container">
                <div className="max-w-xl mx-auto text-center">
                  <h1 className="mb-6 text-4xl font-medium text-center font-display text-jacarta-700 dark:text-white">
                    Xhibiter Affiliate Partnership
                  </h1>
                  <p className="mb-16 text-lg leading-normal dark:text-jacarta-200">
                    Interested in making money with Xhibiter? Earn A 20% Commission For Every Sale You Refer By Recommending
                  ...
                  <div className="dark:bg-jacarta-800 rounded-2.5xl bg-white p-[3.75rem] text-center transition-shadow hover:shadow-xl">
                    <div className="mb-6 inline-flex rounded-full bg-[#CDBCFF] p-2.5">
                      <div className="bg-accent inline-flex h-[4.25rem] w-[4.25rem] items-center justify-center rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="h-[2.25rem] w-[2.25rem] fill-white">
                          <path fill="none" d="M0 0h24v24H0z" />
              ...
              <div className="container">
                <div className="max-w-xl mx-auto mb-20 text-center">
                  ...
                  <p className="dark:text-jacarta-300">
                    While we take pride in being the first and largest marketplace and in our robust feature set, we also help
                    our partners succeed with the following...
                  </p>
                </div>
                <div className="grid gap-7 md:grid-cols-3">
                  <div className="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 rounded-2.5xl mb-12 border bg-white p-8 pt-0 text-center transition-shadow hover:shadow-xl">
                    <div className="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 mb-9 -mt-8 inline-flex h-[5.5rem] w-[5.5rem] items-center justify-center rounded-full border bg-white">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="w-12 h-12 fill-accent">
                        <path fill="none" d="M0 0h24v24H0z" />
                    ...
                    <h3 className="mb-4 text-lg font-display text-jacarta-700 dark:text-white">Generate Revenue</h3>
                    <p className="dark:text-jacarta-300">
                      With millions in transactions since 2017, we'll help you generate revenue on our platform ⁠— from direct
                      sales to secondary sales
                    </p>
                  </div>
                  <div className="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 rounded-2.5xl mb-12 border bg-white p-8 pt-0 text-center transition-shadow hover:shadow-xl">
                    <div className="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 mb-9 -mt-8 inline-flex h-[5.5rem] w-[5.5rem] items-center justify-center rounded-full border bg-white">
                    ...
                    <h3 className="mb-4 text-lg font-display text-jacarta-700 dark:text-white">Reach Millions</h3>
                    <p className="dark:text-jacarta-300">
                  ...
                  <div className="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 rounded-2.5xl mb-12 border bg-white p-8 pt-0 text-center transition-shadow hover:shadow-xl">
                    ...
                    <h3 className="mb-4 text-lg font-display text-jacarta-700 dark:text-white">Spend Less</h3>
                    <p className="dark:text-jacarta-300">
                      Compared with other NFT marketplaces, we have lowest fees in the space allowing you to spend less with
                  ...
                  <div className="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 rounded-2.5xl mb-12 border bg-white p-8 pt-0 text-center transition-shadow hover:shadow-xl">
                    ...
                    <h3 className="mb-4 text-lg font-display text-jacarta-700 dark:text-white">Gas-free Marketplace</h3>
                    <p className="dark:text-jacarta-300">
                  ...
                  <div className="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 rounded-2.5xl mb-12 border bg-white p-8 pt-0 text-center transition-shadow hover:shadow-xl">
                    ...
                    <h3 className="mb-4 text-lg font-display text-jacarta-700 dark:text-white">Advertise Xhibiter</h3>
                    <p className="dark:text-jacarta-300">
                  ...
                  <div className="dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 rounded-2.5xl mb-12 border bg-white p-8 pt-0 text-center transition-shadow hover:shadow-xl">
                    ...
                    <h3 className="mb-4 text-lg font-display text-jacarta-700 dark:text-white">Earn 20% Commission Per Sale!</h3>
                    <p className="dark:text-jacarta-300">
                      With over thousands of collections, we are proud to host the widest range of categories, ranging from
            ...
            <section className="relative py-24">
              ...
              <div className="container">
                ...
                <div className="pt-20 pb-24">
                  <h2 className="mb-10 text-xl font-medium text-center font-display text-jacarta-700 dark:text-white">
                    Frequently asked questions
                  </h2>
                  <p className="max-w-md mx-auto mb-10 text-lg text-center dark:text-jacarta-300">
                    Join our community now to get free updates and also alot of freebies are waiting for you or
                    <a href="contact.html" className="text-accent">Contact Support</a>
                  </p>
                  <div className="accordion mx-auto max-w-[35rem]" id="accordionFAQ">
                    <div className="mb-5 overflow-hidden border rounded-lg accordion-item dark:border-jacarta-600 border-jacarta-100">
                      <h2 className="accordion-header" id="faq-heading-1">
                        <button className="relative flex items-center justify-between w-full px-4 py-3 text-left bg-white accordion-button dark:bg-jacarta-700 font-display text-jacarta-700 collapsed dark:text-white" type="button" data-bs-toggle="collapse" data-bs-target="#faq-1" aria-expanded="false" aria-controls="faq-1">
                          <span>How do I create an NFT?</span>
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="w-4 h-4 transition-transform accordion-arrow fill-jacarta-700 shrink-0 dark:fill-white">
                            <path fill="none" d="M0 0h24v24H0z" />
                            <path d="M12 13.172l4.95-4.95 1.414 1.414L12 16 5.636 9.636 7.05 8.222z" />
                          </svg>
                        </button>
                      </h2>
                      <div id="faq-1" className="accordion-collapse collapse" aria-labelledby="faq-heading-1" data-bs-parent="#accordionFAQ">
                        <div className="p-4 bg-white border-t accordion-body dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100">
                          <p className="dark:text-jacarta-200">
                            Learn how to create your very first NFT and how to create your NFT collections. Unique, fully 3D
                            and built to unite the design multiverse. Designed and styled by Digimental.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="mb-5 overflow-hidden border rounded-lg accordion-item dark:border-jacarta-600 border-jacarta-100">
                      <h2 className="accordion-header" id="faq-heading-2">
                        <button className="relative flex items-center justify-between w-full px-4 py-3 text-left bg-white accordion-button dark:bg-jacarta-700 font-display text-jacarta-700 collapsed dark:text-white" type="button" data-bs-toggle="collapse" data-bs-target="#faq-2" aria-expanded="false" aria-controls="faq-2">
                      ...
                      <div id="faq-2" className="accordion-collapse collapse" aria-labelledby="faq-heading-2" data-bs-parent="#accordionFAQ">
                        <div className="p-4 bg-white border-t accordion-body dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100">
                          <p className="dark:text-jacarta-200">
                            Learn how to create your very first NFT and how to create your NFT collections. Unique, fully 3D
                            and built to unite the design multiverse. Designed and styled by Digimental.
                    ...
                    <div className="mb-5 overflow-hidden border rounded-lg accordion-item dark:border-jacarta-600 border-jacarta-100">
                      <h2 className="accordion-header" id="faq-heading-3">
                        <button className="relative flex items-center justify-between w-full px-4 py-3 text-left bg-white accordion-button dark:bg-jacarta-700 font-display text-jacarta-700 collapsed dark:text-white" type="button" data-bs-toggle="collapse" data-bs-target="#faq-3" aria-expanded="false" aria-controls="faq-3">
                      ...
                      <div id="faq-3" className="accordion-collapse collapse" aria-labelledby="faq-heading-3" data-bs-parent="#accordionFAQ">
                        <div className="p-4 bg-white border-t accordion-body dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100">
                          <p className="dark:text-jacarta-200">
                            Learn how to create your very first NFT and how to create your NFT collections. Unique, fully 3D
                            and built to unite the design multiverse. Designed and styled by Digimental.
                    ...
                    <div className="mb-5 overflow-hidden border rounded-lg accordion-item dark:border-jacarta-600 border-jacarta-100">
                      <h2 className="accordion-header" id="faq-heading-4">
                        <button className="relative flex items-center justify-between w-full px-4 py-3 text-left bg-white accordion-button dark:bg-jacarta-700 font-display text-jacarta-700 collapsed dark:text-white" type="button" data-bs-toggle="collapse" data-bs-target="#faq-4" aria-expanded="false" aria-controls="faq-4">
                      ...
                      <div id="faq-4" className="accordion-collapse collapse" aria-labelledby="faq-heading-4" data-bs-parent="#accordionFAQ">
                        <div className="p-4 bg-white border-t accordion-body dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100">
                          <p className="dark:text-jacarta-200">
                            Learn how to create your very first NFT and how to create your NFT collections. Unique, fully 3D
                            and built to unite the design multiverse. Designed and styled by Digimental.
                    ...
                    <div className="mb-5 overflow-hidden border rounded-lg accordion-item dark:border-jacarta-600 border-jacarta-100">
                      <h2 className="accordion-header" id="faq-heading-5">
                        <button className="relative flex items-center justify-between w-full px-4 py-3 text-left bg-white accordion-button dark:bg-jacarta-700 font-display text-jacarta-700 collapsed dark:text-white" type="button" data-bs-toggle="collapse" data-bs-target="#faq-5" aria-expanded="false" aria-controls="faq-5">
                      ...
                      <div id="faq-5" className="accordion-collapse collapse" aria-labelledby="faq-heading-5" data-bs-parent="#accordionFAQ">
                        <div className="p-4 bg-white border-t accordion-body dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100">
                          <p className="dark:text-jacarta-200">
                            Learn how to create your very first NFT and how to create your NFT collections. Unique, fully 3D
                            and built to unite the design multiverse. Designed and styled by Digimental.
                ...
                <div className="dark:bg-jacarta-700 rounded-2.5xl flex flex-wrap bg-white p-10 md:flex-nowrap md:space-x-8 md:p-[4.25rem] lg:space-x-16">
                  <div className="flex items-center justify-center w-16 h-16 mb-8 rounded-full bg-accent shrink-0 md:mb-0 md:w-16">
                  ...
                  <div className="mb-4 md:mb-0">
                    <p className="text-lg leading-normal text-jacarta-700 dark:text-white">
                      Xhibiter is one of the most exciting, important companies in the world right now because it's the portal
                      to the new digital economy. If you're interested in shaping a new business model for creators, this is
                      the team to join.
                    </p>
                    <span className="block mt-12 font-medium text-jacarta-700 font-display text-md dark:text-white">Katie Smith</span>
                    <span className="font-medium tracking-tight dark:text-jacarta-400 text-2xs">General Partner at Entrepreneur</span>
                  </div>
                  <img src="img/testimonials.jpg" alt="" className="rounded-2.5xl w-28 self-start lg:w-auto" />
                </div>
              </div>
            </section>
            ...
            <section className="bg-accent py-28">
              <div className="container">
                <div className="max-w-2xl mx-auto text-center">
                  <h2 className="max-w-sm mx-auto mb-8 text-3xl text-white font-display">
                  ...
                  <a href="contact.html" className="inline-block px-8 py-3 font-semibold text-center transition-all bg-white rounded-full text-accent hover:bg-accent-dark hover:text-white">Sign Up Now</a>
                </div>
              </div>
            </section>
            {/* end cta */}
