    ...
    <div>
          ...
          <header className="js-page-header page-header--transparent fixed top-0 z-20 w-full bg-white/[.15] backdrop-blur transition-colors">
            <div className="flex items-center px-6 py-6 xl:px-24">
              ...
              <form action="search" className="relative ml-12 mr-8 hidden basis-3/12 lg:block xl:ml-[8%]">
                <input type="search" className="focus:ring-accent w-full rounded-2xl border border-none bg-white/[.15] py-3 px-4 pl-10 text-white placeholder-white" placeholder="Search" />
                <span className="absolute top-0 left-0 flex items-center justify-center w-12 h-full rounded-2xl">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="w-4 h-4 fill-white">
              ...
              <div className="fixed inset-0 z-10 items-center invisible ml-auto bg-white opacity-0 js-mobile-menu dark:bg-jacarta-800 lg:visible lg:relative lg:inset-auto lg:flex lg:bg-transparent lg:opacity-100 dark:lg:bg-transparent">
                ...
                <nav className="w-full navbar">
                  <ul className="flex flex-col lg:flex-row">
                    <li className="relative js-nav-dropdown group">
                      <a href="#" className="dropdown-toggle text-jacarta-700 hover:text-accent font-display flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5 lg:text-white lg:hover:text-white" id="navDropdown-1" aria-expanded="false" role="button" data-bs-toggle="dropdown">Home
                      ...
                      <ul className="dropdown-menu dark:bg-jacarta-800 left-0 top-[85%] z-10 hidden min-w-[200px] gap-x-4 whitespace-nowrap rounded-xl bg-white transition-all will-change-transform group-hover:visible group-hover:opacity-100 lg:invisible lg:absolute lg:grid lg:translate-y-4 lg:py-4 lg:px-2 lg:opacity-0 lg:shadow-2xl lg:group-hover:translate-y-2" aria-labelledby="navDropdown-1">
                        ...
                        <li>
                          <a href="home-3.html" className="flex items-center px-5 py-2 transition-colors dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 rounded-xl">
                            <span className="text-sm font-display text-accent">Home 3</span>
                          </a>
                        </li>
                      </ul>
                    </li>
                    <li className="relative js-nav-dropdown group">
                      <a href="#" className="dropdown-toggle text-jacarta-700 hover:text-accent font-display flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5 lg:text-white lg:hover:text-white" id="navDropdown-2" aria-expanded="false" role="button" data-bs-toggle="dropdown">Pages
                        <i className="lg:hidden">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="w-4 h-4 dark:fill-white">
                            <path fill="none" d="M0 0h24v24H0z" />
                            <path d="M12 13.172l4.95-4.95 1.414 1.414L12 16 5.636 9.636 7.05 8.222z" />
                    ...
                    <li className="relative js-nav-dropdown nav-item dropdown group">
                      <a href="#" className="dropdown-toggle text-jacarta-700 hover:text-accent font-display flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5 lg:text-white lg:hover:text-white" id="navDropdown-3" aria-expanded="false" role="button" data-bs-toggle="dropdown">Explore
                        <i className="lg:hidden">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="w-4 h-4 dark:fill-white">
                            <path fill="none" d="M0 0h24v24H0z" />
                            <path d="M12 13.172l4.95-4.95 1.414 1.414L12 16 5.636 9.636 7.05 8.222z" />
                    ...
                    <li className="relative js-nav-dropdown group">
                      <a href="#" className="dropdown-toggle text-jacarta-700 hover:text-accent font-display flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5 lg:text-white lg:hover:text-white" id="navDropdown-4" aria-expanded="false" role="button" data-bs-toggle="dropdown">Resources
                        <i className="lg:hidden">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="w-4 h-4 dark:fill-white">
                            <path fill="none" d="M0 0h24v24H0z" />
                            <path d="M12 13.172l4.95-4.95 1.414 1.414L12 16 5.636 9.636 7.05 8.222z" />
                    ...
                    <li className="group">
                      <a href="#" className="text-jacarta-700 hover:text-accent font-display flex items-center justify-between py-3.5 text-base dark:text-white lg:px-5 lg:text-white lg:hover:text-white">Create</a>
                    </li>
                  </ul>
                </nav>
                ...
                <div className="hidden ml-8 lg:flex xl:ml-12">
                  {/* Wallet */}
                  <a href="#" className="hover:bg-accent focus:bg-accent group flex h-10 w-10 items-center justify-center rounded-full border border-transparent bg-white/[.15] transition-colors" aria-label="wallet">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="w-4 h-4 transition-colors fill-white group-hover:fill-white group-focus:fill-white">
                      <path fill="none" d="M0 0h24v24H0z" />
                  ...
                  <div className="relative js-nav-dropdown group-dropdown">
                    <button className="dropdown-toggle hover:bg-accent focus:bg-accent group ml-2 flex h-10 w-10 items-center justify-center rounded-full border border-transparent bg-white/[.15] transition-colors" id="profileDropdown" aria-expanded="false" data-bs-toggle="dropdown" aria-label="profile">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="w-4 h-4 transition-colors fill-white group-hover:fill-white group-focus:fill-white">
                        <path fill="none" d="M0 0h24v24H0z" />
                  ...
                  {/* Dark Mode */}
                  <a href="#" className="js-dark-mode-trigger hover:bg-accent focus:bg-accent group ml-2 flex h-10 w-10 items-center justify-center rounded-full border border-transparent bg-white/[.15] transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="w-4 h-4 transition-colors dark-mode-light fill-white group-hover:fill-white group-focus:fill-white dark:hidden">
                      <path fill="none" d="M0 0h24v24H0z" />
                      <path d="M11.38 2.019a7.5 7.5 0 1 0 10.6 10.6C21.662 17.854 17.316 22 12.001 22 6.477 22 2 17.523 2 12c0-5.315 4.146-9.661 9.38-9.981z" />
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="hidden w-4 h-4 transition-colors dark-mode-dark fill-white group-hover:fill-white group-focus:fill-white dark:block">
                      <path fill="none" d="M0 0h24v24H0z" />
              ...
              <div className="flex ml-auto lg:hidden">
                {/* Profile */}
                <a href="edit-profile.html" className="hover:bg-accent focus:bg-accent group flex h-10 w-10 items-center justify-center rounded-full border border-transparent bg-white/[.15] transition-colors" aria-label="profile">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="w-4 h-4 transition-colors fill-white group-hover:fill-white group-focus:fill-white">
                    <path fill="none" d="M0 0h24v24H0z" />
                    <path d="M11 14.062V20h2v-5.938c3.946.492 7 3.858 7 7.938H4a8.001 8.001 0 0 1 7-7.938zM12 13c-3.315 0-6-2.685-6-6s2.685-6 6-6 6 2.685 6 6-2.685 6-6 6z" />
                  </svg>
                ...
                {/* Mobile Menu Toggle */}
                <button className="js-mobile-toggle hover:bg-accent focus:bg-accent group ml-2 flex h-10 w-10 items-center justify-center rounded-full border border-transparent bg-white/[.15] transition-colors" aria-label="open mobile menu">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="w-4 h-4 transition-colors fill-white group-hover:fill-white group-focus:fill-white">
                    <path fill="none" d="M0 0h24v24H0z" />
          ...
          <main>
            ...
            <section className="relative h-screen">
              <div className="h-screen swiper full-slider">
                <div className="swiper-wrapper">
                  ...
                  <div className="swiper-slide after:bg-jacarta-900/60 after:absolute after:inset-0">
                    <div className="container relative z-10 h-full pt-40">
                      ...
                      <a href="user.html" className="font-medium text-white text-2xs">By 051_Hart</a>
                    </div>
                    <img src="img/hero/hero_slide_1.jpg" className="absolute inset-0 object-cover w-full h-full" alt="slide 1" />
                  </div>
                  <div className="swiper-slide after:bg-jacarta-900/60 after:absolute after:inset-0">
                    <div className="container relative z-10 h-full pt-40">
                      <h2 className="text-2xl font-semibold text-white font-display">
                      ...
                      <a href="user.html" className="font-medium text-white text-2xs">By THE OVERSEERS</a>
                    </div>
                    <img src="./img/pixel.jpg" data-src="img/hero/hero_slide_2.jpg" className="absolute inset-0 object-cover w-full h-full swiper-lazy" alt="slide 2" />
                  ...
                  <div className="swiper-slide after:bg-jacarta-900/60 after:absolute after:inset-0">
                    <div className="container relative z-10 h-full pt-40">
                      ...
                      <a href="user.html" className="font-medium text-white text-2xs">Generous Shiba Club</a>
                    </div>
                    <img src="./img/pixel.jpg" data-src="img/hero/hero_slide_3.jpg" className="absolute inset-0 object-cover w-full h-full swiper-lazy" alt="slide 3" />
                    <div className="swiper-lazy-preloader" />
                  </div>
                  <div className="swiper-slide after:bg-jacarta-900/60 after:absolute after:inset-0">
                    <div className="container relative z-10 h-full pt-40">
                      ...
                      <a href="user.html" className="font-medium text-white text-2xs">LeeCookNZ</a>
                    </div>
                    <img src="./img/pixel.jpg" data-src="img/hero/hero_slide_4.jpg" className="absolute inset-0 object-cover w-full h-full swiper-lazy" alt="slide 4" />
                    <div className="swiper-lazy-preloader" />
                  </div>
                </div>
              </div>
              ...
              <div className="absolute inset-x-0 bottom-12">
                <div className="container">
                  <div className="swiper full-slider-thumbs">
                    <div className="swiper-wrapper">
                      <div className="p-5 rounded cursor-pointer swiper-slide">
                        ...
                        <div className="carousel-progress relative -bottom-5 z-10 -ml-5 -mr-5 h-0.5 bg-white/20">
                          <div className="progress bg-accent absolute h-0.5 w-0" />
                        </div>
                      </div>
                      <div className="p-5 rounded cursor-pointer swiper-slide">
                      ...
                      <div className="p-5 rounded cursor-pointer swiper-slide">
                        <img src="img/hero/hero_slide_3_thumb.jpg" className="w-full rounded-lg" alt="thumb 3" />
                        <div className="carousel-progress relative -bottom-5 z-10 -ml-5 -mr-5 h-0.5 bg-white/20">
                          <div className="progress bg-accent absolute h-0.5 w-0" />
                        </div>
                      </div>
                      <div className="p-5 rounded cursor-pointer swiper-slide">
                        <img src="img/hero/hero_slide_4_thumb.jpg" className="w-full rounded-lg" alt="thumb 4" />
                        <div className="carousel-progress relative -bottom-5 z-10 -ml-5 -mr-5 h-0.5 bg-white/20">
                          <div className="progress bg-accent absolute h-0.5 w-0" />
                        </div>
                      </div>
            ...
            <section className="py-24">
              <h2 className="mb-8 text-3xl text-center font-display text-jacarta-700 dark:text-white">Browse by category</h2>
              {/* Slider */}
                ...
                <div className="swiper centered-slider !pb-5">
                  <div className="swiper-wrapper">
                    ...
                    <div className="swiper-slide">
                      <article>
                        <a href="collections.html" className="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl block border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg">
                          <figure className="bg-green rounded-t-[0.625rem]">
                            <img src="./img/categories/category_1.png" alt="item 1" className="w-full rounded-[0.625rem]" loading="lazy" />
                          </figure>
                          <div className="mt-4 text-center">
                            <span className="text-lg font-display text-jacarta-700 dark:text-white">Art</span>
                          </div>
                        </a>
                      </article>
                    </div>
                    <div className="swiper-slide">
                      <article>
                        <a href="collections.html" className="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl block border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg">
                          <figure className="bg-orange rounded-t-[0.625rem]">
                            <img src="./img/categories/category_2.png" alt="item 2" className="w-full rounded-[0.625rem]" loading="lazy" />
                          </figure>
                          <div className="mt-4 text-center">
                            <span className="text-lg font-display text-jacarta-700 dark:text-white">Collectibles</span>
                          </div>
                        </a>
                      </article>
                    </div>
                    <div className="swiper-slide">
                      <article>
                        <a href="collections.html" className="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl block border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg">
                          <figure className="bg-accent rounded-t-[0.625rem]">
                            <img src="./img/categories/category_3.png" alt="item 2" className="w-full rounded-[0.625rem]" loading="lazy" />
                          </figure>
                          <div className="mt-4 text-center">
                            <span className="text-lg font-display text-jacarta-700 dark:text-white">Domain Names</span>
                          </div>
                        </a>
                      </article>
                    </div>
                      ...
                      <article>
                        <a href="collections.html" className="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl block border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg">
                          <figure className="rounded-t-[0.625rem] bg-[#46C7E3]">
                            <img src="./img/categories/category_4.png" alt="item 1" className="w-full rounded-[0.625rem]" loading="lazy" />
                          </figure>
                          <div className="mt-4 text-center">
                            <span className="text-lg font-display text-jacarta-700 dark:text-white">Virtual Worlds</span>
                          </div>
                        </a>
                      </article>
                    </div>
                      ...
                      <article>
                        <a href="collections.html" className="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl block border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg">
                          <figure className="rounded-t-[0.625rem] bg-[#737EF2]">
                            <img src="./img/categories/category_5.png" alt="item 1" className="w-full rounded-[0.625rem]" loading="lazy" />
                          </figure>
                          <div className="mt-4 text-center">
                            <span className="text-lg font-display text-jacarta-700 dark:text-white">Sport</span>
                          </div>
                        </a>
                      </article>
                    </div>
                    <div className="swiper-slide">
                      <article>
                        <a href="collections.html" className="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl block border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg">
                          <figure className="bg-blue rounded-t-[0.625rem]">
                            <img src="./img/categories/category_6.png" alt="item 2" className="w-full rounded-[0.625rem]" loading="lazy" />
                          </figure>
                          <div className="mt-4 text-center">
                            <span className="text-lg font-display text-jacarta-700 dark:text-white">Photography</span>
                          </div>
                        </a>
                      </article>
                    </div>
                      ...
                      <article>
                        <a href="collections.html" className="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl block border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg">
                          <figure className="rounded-t-[0.625rem] bg-[#F35BC7]">
                            <img src="./img/categories/category_7.png" alt="item 2" className="w-full rounded-[0.625rem]" loading="lazy" />
                          </figure>
                          <div className="mt-4 text-center">
                            <span className="text-lg font-display text-jacarta-700 dark:text-white">Music</span>
                          </div>
                        </a>
                      </article>
                    </div>
              ...
              <div className="container">
                <div className="flex flex-col space-y-5 lg:flex-row lg:space-y-0 lg:space-x-7">
                  <div className="dark:bg-jacarta-800 bg-light-base rounded-2.5xl p-12 lg:w-1/3">
                    <h2 className="mb-8 text-3xl font-semibold text-center text-jacarta-700 font-display dark:text-white">
                      Today's Drops
                    </h2>
                    ...
                    <a href="collection.html" className="block mt-8 text-sm font-bold tracking-tight text-center text-accent">View All Drops</a>
                  </div>
                  <div className="dark:bg-jacarta-800 bg-light-base rounded-2.5xl p-12 lg:w-1/3">
                    <h2 className="mb-8 text-3xl font-semibold text-center text-jacarta-700 font-display dark:text-white">
                      Top Sellers
                    ...
                    <a href="collection.html" className="block mt-8 text-sm font-bold tracking-tight text-center text-accent">View All Sellers</a>
                  </div>
                  <div className="dark:bg-jacarta-800 bg-light-base rounded-2.5xl p-12 lg:w-1/3">
                    <h2 className="mb-8 text-3xl font-semibold text-center text-jacarta-700 font-display dark:text-white">
                      Top Buyers
                    ...
                    <a href="collection.html" className="block mt-8 text-sm font-bold tracking-tight text-center text-accent">View All Buyers</a>
                  </div>
                </div>
              </div>
            </section>
