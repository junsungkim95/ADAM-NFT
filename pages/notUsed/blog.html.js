            ...
            <section className="relative py-16 md:py-24">
              ...
              <div className="container">
                ...
                <article className="mb-[1.875rem] md:mb-16">
                  <div className="rounded-2.5xl flex flex-col overflow-hidden transition-shadow hover:shadow-lg md:flex-row">
                    <figure className="overflow-hidden group md:w-1/2">
                      <a href="single-post.html">
                        <img src="img/blog/post_1.jpg" alt="post 1" className="h-full w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105" />
                      </a>
                    </figure>
                    {/* Body */}
                    <div className="dark:border-jacarta-600 dark:bg-jacarta-700 border-jacarta-100 rounded-b-[1.25rem] border bg-white p-[10%] md:w-1/2 md:rounded-none md:rounded-r-[1.25rem]">
                      ...
                      <h2 className="mb-4 text-xl font-display text-jacarta-700 dark:hover:text-accent hover:text-accent dark:text-white sm:text-3xl">
                ...
                <div className="grid grid-cols-1 gap-[1.875rem] sm:grid-cols-2 md:grid-cols-3">
                  ...
                  <article>
                    <div className="rounded-2.5xl overflow-hidden transition-shadow hover:shadow-lg">
                      <figure className="overflow-hidden group">
                        <a href="single-post.html">
                          <img src="img/blog/post_5.jpg" alt="post 5" className="h-full w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105" />
                        </a>
                      </figure>
                      {/* Body */}
                      <div className="dark:border-jacarta-600 dark:bg-jacarta-700 border-jacarta-100 rounded-b-[1.25rem] border border-t-0 bg-white p-[10%]">
                ...
                <div className="mt-10 text-center">
                  <a href="blog.html" className="inline-block px-8 py-3 font-semibold text-center text-white transition-all rounded-full bg-accent shadow-accent-volume hover:bg-accent-dark">Load More</a>
                </div>
              </div>
            </section>
            {/* end blog */}
