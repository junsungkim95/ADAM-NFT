  ...
  return (
    <div>
          ...
          <main className="pt-[5.5rem] lg:pt-24">
            {/* Page Title */}
            <section className="relative py-20 bg-center bg-no-repeat bg-cover after:bg-jacarta-900/60 after:absolute after:inset-0" style={{backgroundImage: 'url("./img/page-title/knowledge_base_banner.jpg")'}}>
              <div className="container relative z-10">
                <h1 className="mb-4 text-4xl font-medium text-center text-white font-display">How can I help you?</h1>
                <form action="search" className="relative block max-w-md mx-auto">
                  <input type="search" className="text-jacarta-700 placeholder-jacarta-500 focus:ring-accent border-jacarta-100 w-full rounded-2xl border py-[0.6875rem] px-4 pl-10" placeholder="Search" />
                  <span className="absolute top-0 left-0 flex items-center justify-center w-12 h-full rounded-2xl">
            ...
            <section className="relative py-24">
              ...
              <div className="container">
                ...
                {/* Categories */}
                <div className="grid grid-cols-1 mb-16 gap-7 sm:grid-cols-2 md:grid-cols-3">
                  <a href="#" className="p-6 text-center transition-shadow bg-white border dark:border-jacarta-600 dark:bg-jacarta-700 rounded-2lg border-jacarta-100 hover:shadow-lg">
                    <h3 className="mb-2 text-base font-semibold font-display text-jacarta-700 dark:text-white">
                      Getting started
                    </h3>
                  ...
                  <a href="#" className="p-6 text-center transition-shadow bg-white border dark:border-jacarta-600 dark:bg-jacarta-700 rounded-2lg border-jacarta-100 hover:shadow-lg">
                    <h3 className="mb-2 text-base font-semibold font-display text-jacarta-700 dark:text-white">Buying</h3>
                    <p className="dark:text-jacarta-300">
                      Learn how to create an account, set up your wallet, and what you can do.
                    </p>
                  </a>
                  <a href="#" className="p-6 text-center transition-shadow bg-white border dark:border-jacarta-600 dark:bg-jacarta-700 rounded-2lg border-jacarta-100 hover:shadow-lg">
                    <h3 className="mb-2 text-base font-semibold font-display text-jacarta-700 dark:text-white">Selling</h3>
                    <p className="dark:text-jacarta-300">
                      Learn how to create an account, set up your wallet, and what you can do.
                    </p>
                  </a>
                  <a href="#" className="p-6 text-center transition-shadow bg-white border dark:border-jacarta-600 dark:bg-jacarta-700 rounded-2lg border-jacarta-100 hover:shadow-lg">
                    <h3 className="mb-2 text-base font-semibold font-display text-jacarta-700 dark:text-white">Creating</h3>
                    <p className="dark:text-jacarta-300">
                      Learn how to create an account, set up your wallet, and what you can do.
                    </p>
                  </a>
                  <a href="#" className="p-6 text-center transition-shadow bg-white border dark:border-jacarta-600 dark:bg-jacarta-700 rounded-2lg border-jacarta-100 hover:shadow-lg">
                    <h3 className="mb-2 text-base font-semibold font-display text-jacarta-700 dark:text-white">User Safety</h3>
                    <p className="dark:text-jacarta-300">
                      Learn how to create an account, set up your wallet, and what you can do.
                    </p>
                  </a>
                  <a href="#" className="p-6 text-center transition-shadow bg-white border dark:border-jacarta-600 dark:bg-jacarta-700 rounded-2lg border-jacarta-100 hover:shadow-lg">
                    <h3 className="mb-2 text-base font-semibold font-display text-jacarta-700 dark:text-white">Partners</h3>
                    <p className="dark:text-jacarta-300">
                      Learn how to create an account, set up your wallet, and what you can do.
                    </p>
                  </a>
                ...
                <p className="max-w-md mx-auto mb-10 text-lg text-center text-jacarta-300">
