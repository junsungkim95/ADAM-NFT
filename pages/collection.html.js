      ...
      <main className="pt-[5.5rem] lg:pt-24">
        ...
        <section className="relative pb-12 bg-light-base pt-28 dark:bg-jacarta-800">
          ...
          <div className="container">
            <div className="text-center">
              ...
              <div className="inline-flex flex-wrap items-center justify-center mb-8 bg-white border rounded-xl border-jacarta-100 dark:border-jacarta-600 dark:bg-jacarta-800">
                <a
                  href="#"
                  className="w-1/2 py-4 border-r rounded-l-xl border-jacarta-100 hover:shadow-md dark:border-jacarta-600 sm:w-32"
                >
                ...
                <a
                  href="#"
                  className="w-1/2 py-4 border-jacarta-100 hover:shadow-md dark:border-jacarta-600 sm:w-32 sm:border-r"
                >
                  <div className="mb-1 text-base font-bold text-jacarta-700 dark:text-white">
                    5.3K
                  </div>
                ...
                <a
                  href="#"
                  className="w-1/2 py-4 border-r border-jacarta-100 hover:shadow-md dark:border-jacarta-600 sm:w-32"
                >
                ...
                <a
                  href="#"
                  className="w-1/2 py-4 rounded-r-xl border-jacarta-100 hover:shadow-md sm:w-32"
                >
                  <div className="flex items-center justify-center mb-1 text-base font-medium text-jacarta-700 dark:text-white">
                    <span
                      className="inline-block -mt-px"
        ...
        <section className="relative py-24">
          ...
          <div className="container">
            {/* Tabs Nav */}
            <ul
              className="flex items-center justify-center mb-12 border-b nav nav-tabs border-jacarta-100 dark:border-jacarta-600"
              role="tablist"
            >
                          ...
                          <div className="modal-content">
                            ...
                            <div className="modal-body">
                              <div className="accordion" id="accordionProps">
                                <div className="border-b accordion-item border-jacarta-100 dark:border-jacarta-600">
                                  <h2
                                    className="accordion-header"
                                    id="prop-heading-1"
                                  >
                                    <button
                                      className="relative flex items-center justify-between w-full px-6 py-5 bg-white accordion-button collapsed font-display text-jacarta-700 dark:bg-jacarta-700 dark:text-white"
                                      type="button"
                                  ...
                                  >
                                    <div className="px-2 pb-4 accordion-body">
                                      <div className="flex flex-col">
                                        <button className="flex items-center justify-between px-4 py-2 rounded-xl hover:bg-jacarta-50 dark:text-jacarta-200 dark:hover:bg-jacarta-600">
                                          <span>Red</span>
                                          <span>14</span>
                                        </button>
                                        <button className="flex items-center justify-between px-4 py-2 rounded-xl hover:bg-jacarta-50 dark:text-jacarta-200 dark:hover:bg-jacarta-600">
                  ...
                  <div className="mb-10 space-y-5 shrink-0 basis-8/12 lg:mb-0 lg:pr-10">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <span className="block mb-3 text-sm text-jacarta-500 dark:text-jacarta-200">
                          sold for 1.515 ETH
                        </span>
              ...
              <div className="flex space-x-5">
                <a href="#" className="group">
                  <svg
                    ...
                    data-prefix="fab"
                    data-icon="facebook"
                    className="w-5 h-5 fill-jacarta-300 group-hover:fill-accent dark:group-hover:fill-white"
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                  >
