  ...
  return (
    <div>
          ...
          <header className="fixed top-0 z-20 w-full transition-colors js-page-header backdrop-blur">
            <div className="container">
              <div className="flex items-center py-[1.5625rem] lg:py-[1.8125rem]">
                ...
                <span className="hidden mt-1 text-lg font-semibold font-display lg:inline-block">Status</span>
                <a href="#" className="bg-accent shadow-accent-volume hover:bg-accent-dark ml-auto inline-block rounded-full py-2.5 px-8 text-center text-sm font-semibold text-white transition-all">
          ...
          <main className="pt-[5.5rem] lg:pt-24">
            {/* Page Title */}
            <section className="relative py-24 bg-center bg-no-repeat bg-cover after:bg-jacarta-900/60 after:absolute after:inset-0 md:py-32" style={{backgroundImage: 'url("./img/page-title/knowledge_base_banner.jpg")'}}>
              <div className="container relative z-10">
                <h1 className="text-4xl font-medium text-center text-white font-display">Xhibiter System Status</h1>
              </div>
            </section>
            {/* Platform Status */}
            <section className="relative py-24">
              ...
              <div className="container">
                <div className="mx-auto max-w-[53.125rem]">
                  <div className="p-4 mb-16 font-medium text-white rounded-lg bg-green font-display text-md">
                    <span>All Systems Operational</span>
                  </div>
                  {/* Table */}
                  <div className="overflow-hidden bg-white border divide-y rounded-lg dark:bg-jacarta-700 dark:border-jacarta-600 border-jacarta-100 dark:divide-jacarta-600 divide-jacarta-100 mb-14">
                    ...
                    <div className="flex items-center justify-between px-5 py-4">
                      <span className="font-medium text-jacarta-700 dark:text-white">Desktop Application</span>
                      <span className="text-green">Operational</span>
                    </div>
                    <div className="flex items-center justify-between px-5 py-4">
                    ...
                    <div className="flex items-center justify-between px-5 py-4">
                      <span className="font-medium text-jacarta-700 dark:text-white">Mobile Application</span>
                      <span className="text-orange-bright">Active Incident</span>
                    </div>
                    <div className="flex items-center justify-between px-5 py-4">
                      <div className="flex items-center space-x-2">
                        <span className="font-medium text-jacarta-700 dark:text-white">Support Services</span>
                        <span className="inline-block" data-tippy-content="Setting your asset as explicit and sensitive content, like pornography and other not safe for work (NSFW) content, will protect users with safe search while browsing Xhibiter.">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="w-4 h-4 dark:fill-jacarta-300 fill-jacarta-500">
                  ...
                  <h2 className="mb-6 text-xl font-display text-jacarta-700 dark:text-white">Past Incidents</h2>
                  <div className="mb-8">
                    <div className="pb-4 mb-4 text-lg font-medium border-b dark:border-jacarta-600 border-jacarta-100 text-jacarta-700 dark:text-white">
                      Apr 8, 2022
                    </div>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="mb-6">
                      <p className="dark:text-jacarta-300">
                        <strong className="text-jacarta-700 dark:text-white">Resolved</strong> - This incident has been resolved.
                      </p>
                      <time className="text-sm dark:text-jacarta-300">Apr 5, 16:53 UTC</time>
                    </div>
                    <div className="mb-6">
                      <p className="dark:text-jacarta-300">
                        <strong className="text-jacarta-700 dark:text-white">In progress</strong> - Scheduled maintenance is
                    ...
                    <div className="mb-6">
                      <p className="dark:text-jacarta-300">
                        <strong className="text-jacarta-700 dark:text-white">Investigating</strong> - We are experiencing
                  ...
                  <div className="flex items-center justify-between pt-4 mt-12 border-t dark:border-jacarta-600 border-jacarta-100 text-2xs">
                    ...
                    <a href="https://deothemes.com" className="dark:text-jacarta-300 hover:text-blue">Powered by DeoThemes</a>
                  </div>
                </div>
              </div>
            </section>
