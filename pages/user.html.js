      ...
      <header className="fixed top-0 z-20 w-full transition-colors js-page-header backdrop-blur">
        <div className="flex items-center px-6 py-6 xl:px-24">
          ...
          <div className="fixed inset-0 z-10 items-center invisible ml-auto bg-white opacity-0 js-mobile-menu dark:bg-jacarta-800 lg:visible lg:relative lg:inset-auto lg:flex lg:bg-transparent lg:opacity-100 dark:lg:bg-transparent">
            ...
            <form
              action="search"
              className="relative w-full mt-24 mb-8 lg:hidden"
            >
              <input
                type="search"
                ...
                <li className="relative js-nav-dropdown group">
                  ...
                  >
                    <li>
                      ...
                      >
                        <span className="text-sm font-display text-jacarta-700 dark:text-white">
                          Home 1
                        </span>
                      </a>
                    </li>
                      ...
                      >
                        <span className="mr-3 rounded-xl bg-light-base p-[0.375rem]">
                          <svg
                            ...
                            width={24}
                            height={24}
                            className="w-4 h-4 fill-jacarta-700"
                          >
                            <path fill="none" d="M0 0h24v24H0z" />
            ...
            <div className="w-full mt-10 lg:hidden">
              <a
                href="#"
                className="block w-full px-8 py-3 font-semibold text-center text-white transition-all rounded-full js-wallet bg-accent shadow-accent-volume hover:bg-accent-dark"
            ...
            <div className="hidden ml-8 lg:flex xl:ml-12">
              ...
              <div className="relative js-nav-dropdown group-dropdown">
                ...
                >
                  <button
                    className="flex items-center px-5 my-4 leading-none select-none js-copy-clipboard whitespace-nowrap font-display text-jacarta-700 dark:text-white"
                  ...
                  >
                    ...
                    <svg
                      ...
                      width={24}
                      height={24}
                      className="w-4 h-4 mb-px ml-1 fill-jacarta-500 dark:fill-jacarta-300"
                    >
                      <path fill="none" d="M0 0h24v24H0z" />
                  ...
                  <a
                    href="user.html"
                    className="flex items-center px-5 py-2 space-x-2 transition-colors rounded-xl hover:bg-jacarta-50 hover:text-accent focus:text-accent dark:hover:bg-jacarta-600"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
